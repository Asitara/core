			...
			if($blnAdminMenu){
				...
				foreach($arrMenuItems as $strCategory => $arrCategory){
					if($func_check_permission($arrCategory['check'])){
						$html .= '<li data-category="'.$strCategory.'"><a href="#">'.$this->icon_font($arrCategory['icon']).$arrCategory['text'].'</a></li>';
						$html_sub_menu .= '<ul class="sub-menu" data-category="'.$strCategory.'">';
